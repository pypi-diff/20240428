# Comparing `tmp/querent-3.0.4.tar.gz` & `tmp/querent-3.0.5.tar.gz`
...
### Comparing `querent-3.0.4/querent/callback/event_callback_interface.py` & `querent-3.0.5/querent/callback/event_callback_interface.py`
...
### Comparing `querent-3.0.4/querent/common/uri.py` & `querent-3.0.5/querent/common/uri.py`
...
### Comparing `querent-3.0.4/querent/config/core/opensource_llm_config.py` & `querent-3.0.5/querent/config/core/opensource_llm_config.py`
...
### Comparing `querent-3.0.4/querent/config/engine/engine_config.py` & `querent-3.0.5/querent/config/engine/engine_config.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/config/graph_config.py` & `querent-3.0.5/querent/config/graph_config.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/config/ingestor/ingestor_config.py` & `querent-3.0.5/querent/config/ingestor/ingestor_config.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/config/metric/prometheus.py` & `querent-3.0.5/querent/config/metric/prometheus.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/config/resource/resource_config.py` & `querent-3.0.5/querent/config/resource/resource_config.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/config/workflow/workflow_config.py` & `querent-3.0.5/querent/config/workflow/workflow_config.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/core/base_engine.py` & `querent-3.0.5/querent/core/base_engine.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/core/transformers/bert_ner_opensourcellm.py` & `querent-3.0.5/querent/core/transformers/bert_ner_opensourcellm.py`
...
### Comparing `querent-3.0.4/querent/core/transformers/fixed_entities_set_opensourcellm.py` & `querent-3.0.5/querent/core/transformers/fixed_entities_set_opensourcellm.py`
...
### Comparing `querent-3.0.4/querent/core/transformers/gpt_llm_bert_ner_or_fixed_entities_set_ner.py` & `querent-3.0.5/querent/core/transformers/gpt_llm_bert_ner_or_fixed_entities_set_ner.py`
...
### Comparing `querent-3.0.4/querent/core/transformers/relationship_extraction_llm.py` & `querent-3.0.5/querent/core/transformers/relationship_extraction_llm.py`
...
### Comparing `querent-3.0.4/querent/graph/errors.py` & `querent-3.0.5/querent/graph/errors.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/graph/graph.py` & `querent-3.0.5/querent/graph/graph.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/graph/graph_namespace.py` & `querent-3.0.5/querent/graph/graph_namespace.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/graph/ontology.py` & `querent-3.0.5/querent/graph/ontology.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/graph/schema.py` & `querent-3.0.5/querent/graph/schema.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/graph/shacl.py` & `querent-3.0.5/querent/graph/shacl.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/graph/subject.py` & `querent-3.0.5/querent/graph/subject.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/graph/utils.py` & `querent-3.0.5/querent/graph/utils.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/audio/audio_ingestors.py` & `querent-3.0.5/querent/ingestors/audio/audio_ingestors.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/base_ingestor.py` & `querent-3.0.5/querent/ingestors/base_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/code/code_ingestor.py` & `querent-3.0.5/querent/ingestors/code/code_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/csv/csv_ingestor.py` & `querent-3.0.5/querent/ingestors/csv/csv_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/doc/doc_ingestor.py` & `querent-3.0.5/querent/ingestors/doc/doc_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/email/email_ingestor.py` & `querent-3.0.5/querent/ingestors/email/email_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/email/email_reader.py` & `querent-3.0.5/querent/ingestors/email/email_reader.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/github/github_ingestor.py` & `querent-3.0.5/querent/ingestors/github/github_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/html/html_ingestor.py` & `querent-3.0.5/querent/ingestors/html/html_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/images/image_ingestor.py` & `querent-3.0.5/querent/ingestors/images/image_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/ingestor_factory.py` & `querent-3.0.5/querent/ingestors/ingestor_factory.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/ingestor_manager.py` & `querent-3.0.5/querent/ingestors/ingestor_manager.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/json/json_ingestor.py` & `querent-3.0.5/querent/ingestors/json/json_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/pdfs/pdf_ingestor_v1.py` & `querent-3.0.5/querent/ingestors/pdfs/pdf_ingestor_v1.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/ppt/ppt_ingestor.py` & `querent-3.0.5/querent/ingestors/ppt/ppt_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/texts/text_ingestor.py` & `querent-3.0.5/querent/ingestors/texts/text_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/video/video_ingestor.py` & `querent-3.0.5/querent/ingestors/video/video_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/xlsx/xlsx_ingestor.py` & `querent-3.0.5/querent/ingestors/xlsx/xlsx_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/ingestors/xml/xml_ingestor.py` & `querent-3.0.5/querent/ingestors/xml/xml_ingestor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/ner_helperfunctions/attn_scores.py` & `querent-3.0.5/querent/kg/ner_helperfunctions/attn_scores.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/ner_helperfunctions/contextual_embeddings.py` & `querent-3.0.5/querent/kg/ner_helperfunctions/contextual_embeddings.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/ner_helperfunctions/dependency_parsing.py` & `querent-3.0.5/querent/kg/ner_helperfunctions/dependency_parsing.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/ner_helperfunctions/filter_triples.py` & `querent-3.0.5/querent/kg/ner_helperfunctions/filter_triples.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/ner_helperfunctions/fixed_entities.py` & `querent-3.0.5/querent/kg/ner_helperfunctions/fixed_entities.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/ner_helperfunctions/fixed_predicate.py` & `querent-3.0.5/querent/kg/ner_helperfunctions/fixed_predicate.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/ner_helperfunctions/ner_llm_transformer.py` & `querent-3.0.5/querent/kg/ner_helperfunctions/ner_llm_transformer.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/querent_kg.py` & `querent-3.0.5/querent/kg/querent_kg.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/rel_helperfunctions/contextual_predicate.py` & `querent-3.0.5/querent/kg/rel_helperfunctions/contextual_predicate.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/rel_helperfunctions/fixed_relationships.py` & `querent-3.0.5/querent/kg/rel_helperfunctions/fixed_relationships.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/rel_helperfunctions/gpt_pydantic_classes.py` & `querent-3.0.5/querent/kg/rel_helperfunctions/gpt_pydantic_classes.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/rel_helperfunctions/openai_functions.py` & `querent-3.0.5/querent/kg/rel_helperfunctions/openai_functions.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/rel_helperfunctions/questionanswer_llama2.py` & `querent-3.0.5/querent/kg/rel_helperfunctions/questionanswer_llama2.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/rel_helperfunctions/rel_normalize.py` & `querent-3.0.5/querent/kg/rel_helperfunctions/rel_normalize.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/kg/rel_helperfunctions/triple_to_json.py` & `querent-3.0.5/querent/kg/rel_helperfunctions/triple_to_json.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/logging/filters.py` & `querent-3.0.5/querent/logging/filters.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/logging/handlers.py` & `querent-3.0.5/querent/logging/handlers.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/logging/logger.py` & `querent-3.0.5/querent/logging/logger.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/metric/adapters/promethus_adapter.py` & `querent-3.0.5/querent/metric/adapters/promethus_adapter.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/metric/metric_logging_handler.py` & `querent-3.0.5/querent/metric/metric_logging_handler.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/metric/metric_registry.py` & `querent-3.0.5/querent/metric/metric_registry.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/processors/text_cleanup_processor.py` & `querent-3.0.5/querent/processors/text_cleanup_processor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/processors/text_processor.py` & `querent-3.0.5/querent/processors/text_processor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/querent/auto_scaler.py` & `querent-3.0.5/querent/querent/auto_scaler.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/querent/querent.py` & `querent-3.0.5/querent/querent/querent.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/querent/resource_manager.py` & `querent-3.0.5/querent/querent/resource_manager.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/storage/gcs_query.py` & `querent-3.0.5/querent/storage/gcs_query.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/storage/milvus_vectorevent_storage.py` & `querent-3.0.5/querent/storage/milvus_vectorevent_storage.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/storage/neo4j_graphevent_storage.py` & `querent-3.0.5/querent/storage/neo4j_graphevent_storage.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/storage/postgres_graphevent_storage.py` & `querent-3.0.5/querent/storage/postgres_graphevent_storage.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/tools/web_page_extractor.py` & `querent-3.0.5/querent/tools/web_page_extractor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/utils/webpage_extractor.py` & `querent-3.0.5/querent/utils/webpage_extractor.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/workflow/_helpers.py` & `querent-3.0.5/querent/workflow/_helpers.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent/workflow/workflow.py` & `querent-3.0.5/querent/workflow/workflow.py`

 * *Files identical despite different names*

### Comparing `querent-3.0.4/querent.egg-info/PKG-INFO` & `querent-3.0.5/querent.egg-info/PKG-INFO`
...
### Comparing `querent-3.0.4/querent.egg-info/SOURCES.txt` & `querent-3.0.5/querent.egg-info/SOURCES.txt`
...
### Comparing `querent-3.0.4/querent.egg-info/requires.txt` & `querent-3.0.5/querent.egg-info/requires.txt`
...
### Comparing `querent-3.0.4/setup.py` & `querent-3.0.5/setup.py`

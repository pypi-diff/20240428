# Comparing `tmp/abstract_clients-0.0.0.6.tar.gz` & `tmp/abstract_clients-0.0.0.7.tar.gz`
...
## Comparing `abstract_clients-0.0.0.6.tar` & `abstract_clients-0.0.0.7.tar`
...
### Comparing `abstract_clients-0.0.0.6/setup.py` & `abstract_clients-0.0.0.7/setup.py`
...
### Comparing `abstract_clients-0.0.0.6/src/abstract_clients/contact_webtools.py` & `abstract_clients-0.0.0.7/src/abstract_clients/contact_webtools.py`
...
### Comparing `abstract_clients-0.0.0.6/src/abstract_clients/contacts_directory.py` & `abstract_clients-0.0.0.7/src/abstract_clients/contacts_directory.py`

 * *Files identical despite different names*

### Comparing `abstract_clients-0.0.0.6/src/abstract_clients/get_contact_info.py` & `abstract_clients-0.0.0.7/src/abstract_clients/get_contact_info.py`
